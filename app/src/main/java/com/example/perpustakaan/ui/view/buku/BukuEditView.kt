...
import com.example.perpustakaan.ui.viewmodel.buku.EditBukuViewModel
...
fun EditBukuView(
    ...
    viewModel: EditBukuViewModel = viewModel(factory = PenyediaBukuViewModel.Factory)
) {
    ...
    Scaffold(
        topBar = {
            CustomTopAppBar(
                title = DestinasiEditBuku.titleRes,
